...
/*Input:
  ...
  Process:
  - the program uses the InetAddress to resolve the hostname to its IP addresses
  - prints out the hostname and associated IP addresses
  - if the hostname cannot be resolved, an error message is shown
  - the user can repeat the process or exit
